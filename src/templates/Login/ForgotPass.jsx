              ...
              <form onSubmit={formik.handleSubmit}> {/* Formulário com gerenciamento de submissão */}
                <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                  ...
                  <Typography component="h1" variant="h5" sx={{ color: textColor }}>
                    Recuperar Senha {/* Título do formulário */}
                  </Typography>
                </Box>
                <div className="mb-2">
                  <TextField
                    ...
                    sx={{'& .MuiOutlinedInput-root': {'& fieldset': {borderColor: textColor,}, // Estilo do campo
                ...
                >
                  Enviar E-mail {/* Texto do botão */}
                </Button>
              
                <Box item xs>
                  <Link to="/login" variant="body2" className="link-color"> {/* Link para voltar */}
                    Voltar
                  </Link>
                </Box>
              </form>
